...
function add_popup(str){
  $('body').append('<div class="login-popup" style="width:300px;"><div class="close-popup">x</div><div class="popup_thongbao"><p class="tieude_tb">'+lang_thongbao+'</p><p class="popup_kq">'+str+'</p></div></div>');
  $('.thongbao').html('');
